            ...
            case NORMAL:
                ...
                switch (event.getFrom().getWorld().getEnvironment()) {
                    ...
                    case NORMAL:
                        ...
                        if ((abs(event.getFrom().getBlockX() - worldConfigs.get(event.getFrom().getWorld().getName()).getVector(event.getPlayer().getName()).getX()) <= 4)
                                && (abs(event.getFrom().getBlockY() - worldConfigs.get(event.getFrom().getWorld().getName()).getVector(event.getPlayer().getName()).getY()) <= 4)
                                && (abs(event.getFrom().getBlockZ() - worldConfigs.get(event.getFrom().getWorld().getName()).getVector(event.getPlayer().getName()).getZ()) <= 4)) {
